...
Ce module ne fait PAS de détection de modulation : la copie qui vivait
dans harmonia_min l'avait laissée derrière (2026-07-30) et personne ne l'a
réclamée ; la tonique causale est le travail de harmonic_key.
"""
