"""La page Soudure, servie sur les vrais morceaux.
    ...
    .venv/bin/python tools/soudure_pages.py [<stem> ...]
...
matière que `archive/scripts/bpe_lab.py`. La différence est ce qu'on en fait : bpe_lab
...
from tools.sections_bench.ssm_zoo import SONGS, AUDIO          # noqa: E402
from tools.sections_bench.vote_fill import fill                # noqa: E402
