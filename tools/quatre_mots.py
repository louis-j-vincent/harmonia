"""On soude jusqu'à des sections de QUATRE mots, et A′ est un A qui finit autrement.
    ...
    .venv/bin/python tools/quatre_mots.py [<stem> ...]
...
from tools.sections_bench.ssm_zoo import SONGS, AUDIO, GT_LINE, gt_sections     # noqa: E402
from tools.sections_bench.peak_profile import page                              # noqa: E402
from tools.sections_bench.hard_prior_sections import colourmap                  # noqa: E402
from tools.sections_bench.change_curves import load_curves, draw_curves         # noqa: E402
from tools.sections_bench.vote_fill import (fill, fig2b64_fixed, SYMCOL,        # noqa: E402
                       PLOT_L, PLOT_R, INK, HARD)
from tools.sections_bench import order_bundle                                   # noqa: E402
