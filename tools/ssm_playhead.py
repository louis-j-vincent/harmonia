"""La matrice SSM d'un morceau, cliquable, avec tête de lecture.
    ...
    .venv/bin/python tools/ssm_playhead.py                 # les charts annotés
    .venv/bin/python tools/ssm_playhead.py <stem> [<stem>…]
    .venv/bin/python tools/ssm_playhead.py --tous          # toute la bibliothèque
